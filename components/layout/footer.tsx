      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold text-xl">Jersey Store</span>
            </div>
            <p className="text-gray-400 leading-relaxed">
              Your premier destination for authentic sport jerseys from all major leagues and teams. Quality guaranteed,
              passion delivered.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center space-x-3 text-gray-400">
                ...
                <span className="text-sm">support@jerseystore.com</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-400">
                <Phone className="h-4 w-4" />
                <span className="text-sm">1-800-JERSEYS</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-400">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">© 2024 Jersey Store. All rights reserved.</p>
