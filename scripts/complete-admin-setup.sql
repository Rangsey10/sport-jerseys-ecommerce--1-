-- COMPLETE ADMIN & ORDER MANAGEMENT SETUP
...
SELECT '1. Set an admin user: UPDATE public.profiles SET role = ''admin'' WHERE email = ''your-email@example.com'';' as step_1;
SELECT '2. Test order creation at /test-orders' as step_2;
SELECT '3. Login as admin to access /admin dashboard' as step_3;
